...
def test_unauthorisied(jmb, client):
    ...
    assert r.data == (
        ...
        "\n"
        """<html jmb:name="/tasks" jmb:data=\'{"changesUrl":true,"state":{},"url":"/tasks"}\'>"""
        """<head><title jmb:name="/tasks/page_title" jmb:data=\'{"changesUrl":false,"state":{"title":""},"url":"/tasks/page_title"}\'></title></head>"""
        """<body>"""
...
def test_empty_list(jmb, client):
    ...
    assert r.data == (
        ...
        "\n"
        """<html jmb:name="/tasks" jmb:data=\'{"changesUrl":true,"state":{},"url":"/tasks"}\'>"""
        """<head><title jmb:name="/tasks/page_title" jmb:data=\'{"changesUrl":false,"state":{"title":"Tasks"},"url":"/tasks/page_title"}\'>Tasks</title></head>"""
        """<body>"""
        """<div jmb:name="/tasks/tasks" jmb:data=\'{"changesUrl":true,"state":{"mode":"list","parent_task_id":null,"wip_id":null},"url":"/tasks/tasks"}\'>"""
