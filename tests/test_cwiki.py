...
def test_wiki(jmb, client):
    ...
    assert r.data == (
        ...
        "\n"
        """<html jmb:name="/wiki" jmb:data=\'{"changesUrl":true,"state":{"mode":"view"},"url":"/wiki"}\'>"""
        """<head><title jmb:name="/wiki/page_title" jmb:data=\'{"changesUrl":false,"state":{"title":"Root"},"url":"/wiki/page_title"}\'>Root</title></head>"""
        """<body>"""
        """<div jmb:name="/wiki/view" jmb:data=\'{"changesUrl":true,"state":{"page_path":"root"},"url":"/wiki/view/root"}\'>"""
        """<h1>Root</h1>"""
        """<div></div>"""
        """</div>"""
        """</body></html>"""
    ...
    assert r.data == (
        ...
        "\n"
        """<html jmb:name="/wiki" jmb:data=\'{"changesUrl":true,"state":{"mode":"view"},"url":"/wiki"}\'>"""
        """<head><title jmb:name="/wiki/page_title" jmb:data=\'{"changesUrl":false,"state":{"title":"New Root"},"url":"/wiki/page_title"}\'>New Root</title></head>"""
        """<body>"""
        """<div jmb:name="/wiki/view" jmb:data=\'{"changesUrl":true,"state":{"page_path":"root"},"url":"/wiki/view/root"}\'>"""
        """<h1>New Root</h1>"""
    ...
    assert r.data == (
        ...
        "\n"
        """<html jmb:name="/wiki" jmb:data=\'{"changesUrl":true,"state":{"mode":"view"},"url":"/wiki"}\'>"""
        """<head><title jmb:name="/wiki/page_title" jmb:data=\'{"changesUrl":false,"state":{"title":"Jembe Page"},"url":"/wiki/page_title"}\'>Jembe Page</title></head>"""
        """<body>"""
        """<div jmb:name="/wiki/view" jmb:data=\'{"changesUrl":true,"state":{"page_path":"root/jembe"},"url":"/wiki/view/root/jembe"}\'>"""
        """<h1>Jembe Page</h1>"""
