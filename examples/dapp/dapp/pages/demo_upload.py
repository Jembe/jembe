...
# TODO make tests to check:
# is photo deleted from temp on the end of request
# test upload basic just to have something
class DemoUploadSimple(Component):
    ...
    def __init__(self, photo: Optional[File] = None, upload_to_public: bool = True):
...
@jmb.page(
    "demo_upload",
    Component.Config(
        components=dict(simple=DemoUploadSimple, wtform=DemoUploadWtForm,)
    ),
)
